...
--
-- Servidor: localhost
-- Tiempo de generación: 07-09-2023 a las 22:26:43
...
--
-- Base de datos: `cinelandia_inventario`
--
...
INSERT INTO `productos` (`id_producto`, `descripcion_producto`, `cantidad_total`, `fecha_vencimiento`, `id_proveedor`, `id_categoria`, `precio_unitario`, `costo_mayor`, `gramos-ml`) VALUES
(1, 'cri cri', 12, '2024-07-25', 1, 1, 1.50, 15.00, ''),
(2, 'doritos', 12, '2024-07-25', 2, 2, 4.00, 18.00, ''),
(3, 'doritos', 12, '2024-07-25', 2, 2, 1.50, 18.00, '70'),
(7, 'helados', 30, '2023-12-12', 2, 2, 0.00, 50.00, ''),
(8, 'pepitos', 10, '0000-00-00', 1, 2, 0.00, 15.00, ''),
(9, 'G', 10, '0000-00-00', 1, 1, 0.00, 10.00, '');
