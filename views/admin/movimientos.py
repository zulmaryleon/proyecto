...
def movimientos(contenedor_derecho):
    ...
    tabla_movimientos = ttk.Treeview(frame_principal, columns=("id", "descripcion","total", "usuario", "status"), show="headings", style="Custom.Treeview")
    ...
    tabla_movimientos.heading("status", text="Status")
