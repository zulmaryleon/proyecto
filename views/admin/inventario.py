...
from app.admin.inventario import consultar_producto, datos_tabla_inventario, crear_producto
...
def inventario(contenedor_derecho):
    ...
    boton_guardar_inventario=tk.Button(frame_principal,text="crear producto", command=crear_producto)
