...
def hacer_venta(id_producto, ventana, cantidad, precio, tabla_producto):
    ...
    boton_confirmar = tk.Button(ventana_confirmacion, text="Confirmar", command=lambda:confirmar(id_producto, tabla_producto, ventana, ventana_confirmacion))
